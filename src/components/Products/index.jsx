...
const productList = [
    ...
    { id: 5, name: 'Produto F', description: 'Descrição do produto F', price: 6.99 },
    { id: 6, name: 'Produto G', description: 'Descrição do produto G', price: 7.99 },
    { id: 7, name: 'Produto H', description: 'Descrição do produto H', price: 8.99 }
]
